...
local PANEL = {}
--DEFINE_BASECLASS("DContainerTTT2")

setmetatable( PANEL, {__index = baseclass.Get( "DContainerTTT2" ) }, {__index = baseclass.Get( "ExtensionTTT2" ) })
...
--, {__index = PANEL_EXTENSION} )

include("extension_ttt2.lua")
...
-- --derma.DefineControl("ContainerTTT2_extended", "", PANEL, "DFormTTT2_extended")


-- function vgui.CreateTTT2Container_extended(parent, name)
-- 	print("Creating ContainerTTT2_extended")
--     local name = name or ""
